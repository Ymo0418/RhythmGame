...
object ObjectManager : Base() {
    public enum class LayerType {
        CAMERA, PLAYER, SKILL, MONSTER, BACKGROUND, UI
    }
    private val LayerOrder = listOf(
        LayerType.CAMERA, LayerType.PLAYER, LayerType.SKILL, LayerType.MONSTER, LayerType.BACKGROUND, LayerType.UI
    )
