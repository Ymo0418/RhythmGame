...
import com.example.rhythmgame.Manager.InputManager
...
import com.example.rhythmgame.Object.JustRenderObject_ForTest
...
class MyGLRenderer(private val context: Context) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(unused: javax.microedition.khronos.opengles.GL10?, config: javax.microedition.khronos.egl.EGLConfig?) {
        ...
        ObjectManager.Add_Object(ObjectManager.LayerType.BACKGROUND, JustRenderObject_ForTest("TextureCom_Field",
        ...
        //SoundManager.LoadSFX(context, "tap", R.raw.tap)
    ...
    public fun setTouchPosition(x: Float, y: Float) {
        InputManager.Set_TouchInput(x, y)
    }
